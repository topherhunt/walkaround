defmodule WalkaroundWeb do
  ...
  def static_paths, do: ~w(assets fonts images favicon.ico robots.txt test.html)
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: WalkaroundWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {WalkaroundWeb.Layouts, :app}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: WalkaroundWeb.Router,
        statics: WalkaroundWeb.static_paths()
    end
  end

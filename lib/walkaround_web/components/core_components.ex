defmodule WalkaroundWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WalkaroundWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WalkaroundWeb.Gettext, "errors", msg, opts)
    end
  end
